...
import cl.disma.cl.emedpro.dao.ReservaDAO;
...
public class ReservaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        listaReservas = reservasDAO.obtenerReservas();

        // Mostrar en consola
        for (Reserva r : listaReservas) {
            System.out.println("Reserva ID: " + r.getId());
            System.out.println("Título: " + r.getTitle());
            System.out.println("Inicio: " + r.getStart());
            System.out.println("Fin: " + r.getEnd());
            System.out.println("--------------------------");
        }
